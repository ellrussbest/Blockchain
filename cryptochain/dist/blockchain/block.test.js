...
(0, globals_1.describe)("Block", () => {
    ...
    (0, globals_1.describe)("genesis()", () => {
        const genesisBlock = (0, block_1.genesis)();
        (0, globals_1.it)("returns a Block instance", () => {
            (0, globals_1.expect)(genesisBlock instanceof block_1.default).toBe(true);
        });
        (0, globals_1.it)("returns the genesis data", () => {
            (0, globals_1.expect)(genesisBlock).toEqual(utils_1.GENESIS_DATA);
        });
    });
    (0, globals_1.describe)("mineBlock()", () => {
        const lastBlock = (0, block_1.genesis)();
        const data = ["mined data"];
        const minedBlock = (0, block_1.mineBlock)({ lastBlock, data });
        ...
        (0, globals_1.it)("returns a Block instance", () => {
            (0, globals_1.expect)(minedBlock instanceof block_1.default).toBe(true);
        });
        ...
        (0, globals_1.it)("creates a SHA-256 `hash` based on the proper inputs", () => {
            (0, globals_1.expect)(minedBlock.hash).toEqual((0, utils_1.cryptoHash)(minedBlock.timestamp, minedBlock.nonce.toString(), minedBlock.difficulty.toString(), lastBlock.hash, ...dataToBeHashed));
        });
        (0, globals_1.it)("sets a `hash` that matches the difficulty criteria", () => {
            (0, globals_1.expect)((0, utils_1.hexToBinary)(minedBlock.hash).substring(0, minedBlock.difficulty)).toEqual("0".repeat(minedBlock.difficulty));
        });
    ...
    (0, globals_1.describe)("adjustDifficulty()", () => {
        (0, globals_1.it)("raises the difficulty for a quickly mined block", () => {
            (0, globals_1.expect)((0, block_1.adjustDifficulty)({
                lastBlock: block,
                timestamp: parseInt(block.timestamp) + utils_1.MINE_RATE - 100,
